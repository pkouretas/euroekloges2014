...
public class ResultsParties extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.results_parties);
		
		mTextView = (TextView) findViewById(R.id.party_results_tv);
		rootView = (LinearLayout) findViewById(R.id.party_results_container);
		...
		// TODO: den thymamai ti
		for (Party party : Ekloges14APP.parties) {

			LinearLayout partyResultTable = (LinearLayout) inflater.inflate(
					R.layout.grid_result_table, rootView, false);
			((TextView) partyResultTable.findViewById(R.id.grid_result_table_header)).setText(party
					.getName() + "\n" + "Σύνολο ψήφων συνδυασμού: " + party.getBallots().size());
			TableLayout ballotsTable = (TableLayout) partyResultTable
			...
			rootView.addView(partyResultTable);
		}
